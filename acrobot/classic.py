#!/usr/bin/env python3
"""
Switch Acrobot with decoupled uncertainty (Classic variant):
...
def train(args):
    ...
    print(f"Acrobot Classic | Episodes: {args.episodes} | Switch at: {args.switch_ep}")
    ...
    fig.tight_layout()
    plt.title("Switch Acrobot - Classic (Decoupled Uncertainty)")
