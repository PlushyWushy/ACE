#!/usr/bin/env python3
"""
Plot average reward rate (with std shading) across all `*_classic` runs in sb_gradual.
"""
...
OUT_PNG = Path("sb_gradual/classic_avg_reward_rate.png")
OUT_STATS = Path("sb_gradual/classic_reward_rate_stats.csv")
WINDOW = 50
...
def main():
    ...
    if not runs:
        print('No classic gradual runs found.')
        return
    ...
    plt.title('Classic - Average Reward Rate across seeds (±STD) - Gradual')
