#!/usr/bin/env python3
"""
Aggregate rewards for icarussecondpaper runs.
Produces:
- icarussecondpaper/total_rewards_comparison.csv
- icarussecondpaper/late_rewards_comparison.csv
"""
from pathlib import Path
import csv

RUNS_DIR = Path("icarussecondpaper/runs")
OUT_TOTAL = Path("icarussecondpaper/total_rewards_comparison.csv")
OUT_LATE = Path("icarussecondpaper/late_rewards_comparison.csv")
LATE_EP = 8000  # 0-based: episodes >= 8000
