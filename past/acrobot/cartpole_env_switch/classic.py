...
def train(args):
    ...
    fig.suptitle("CartPole Env Switch — Classic Baseline", fontsize=14)
    ...
    out_dir = f"icarussecondpaper/runs/{args.seed}_classic" if args.seed is not None else "cartpole/runs/noseed_classic"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--switch_ep", type=int, default=10000)
